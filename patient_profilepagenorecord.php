...
try {
    ...
    // Fetch user data from the users table based on user_id.
    $stmtUser = $pdo->prepare("SELECT * FROM users WHERE user_id = :userId");
    $stmtUser->bindParam(':userId', $_SESSION['user_id'], PDO::PARAM_INT);
    $stmtUser->execute();
...
<body class="">
    <div class="sidebar bg-[#e4e9f7]">
        ...
        <ul class="nav-list">
            <li class="active">
                <a href="patient_profilepage.php">
            ...
            <li class="">
            <a href="patientdashboardnorecord.php">
           ...
           <form id="editProfile" action="editProfile.php" method="post">
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input name="username" type="text" class="form-control mb-1" style="width: 550px;" value="<?php echo $_SESSION['username']; ?>">
                                            </div>
                                            <br>
                                            <div class="form-group">
                                                <label class="form-label">First Name</label>
                                                <input name="first_name" type="text" class="form-control" style="width: 550px;" value="<?php echo $_SESSION['first_name']; ?>">
                                            </div>
                                            <br>
                                            <div class="form-group">
                                                <label class="form-label">Last Name</label>
                                                <input name="last_name" type="text" class="form-control" style="width: 550px;" value="<?php echo $_SESSION['last_name']; ?>">
                                            </div>
                                            <br>
                                            <div class="form-group">
                                                <label class="form-label">E-mail</label>
                                                <input type="text" class="form-control mb-1" style="width: 350px;" disabled value="<?php echo $_SESSION['email']; ?>">
                                            </div>
                                            <div class="form-group d-flex justify-content-end"> <!-- Add this line -->
    <button class="btn btn-primary btn-lg rounded-pill px-4 py-2 bg-blue-500 text-white hover:bg-blue-600 hover:text-white" type="submit">Submit</button>
</div>
...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.15.4/css/all.css" integrity="sha384-DyZ88mC6Up2uqS4h/KRgHuoeGwBcD4Ng9SiP4dIRy0EXTlnuz47vAwmeGwVChigm" crossorigin="anonymous" />
    ...
    <form action="change_password_patient.php" method="post" onsubmit="return validatePassword()">
        <div class="card-body pb-2">
          <div class="form-group">
    <label class="form-label">Current password</label>
    <div class="input-group">
        <input type="password" class="form-control" name="current_password" id="current_password" style="width: 550px;"  placeholder="Current Password" required>
...
<div class="form-group">
    ...
    <div class="input-group">
        <input type="password" class="form-control" name="new_password" id="new_password" style="width: 550px;" placeholder="New Password" required>
        <div class="input-group-append">
            <span class="input-group-text">
...
<div class="form-group">
    ...
    <div class="input-group">
        <input type="password" class="form-control" name="confirm_password" id="confirm_password" style="width: 550px;" placeholder="Retype New Password" required>
        <div class="input-group-append">
            <span class="input-group-text">
            ...
            <button type="submit" class="bg-green-500 text-white py-2 px-4 rounded-lg" id="saveChangesBtn">Save changes</button>
...
<div id="successProfileModal" class="fixed inset-0 z-50 flex items-center justify-center backdrop-blur hidden">
    <div class="bg-white p-6 rounded shadow-lg">
        ...
        <div class="text-center">
            <button id="closeSuccessProfileModalBtn" class="px-4 py-2 bg-blue-500 text-white rounded" onclick="closeSuccessProfileModal()">Close</button>
        </div>
    </div>
</div>
...
<div id="errorFormatModal" class="fixed inset-0 z-50 flex items-center justify-center backdrop-blur hidden">
  <div class="bg-white p-6 rounded shadow-lg">
    <div class="text-center mb-4">
      <h2 class="text-2xl font-bold">New Password must be at least 8 characters long and include uppercase, lowercase, numbers, and special characters (@$!%*?&).</h2>
...
document.addEventListener('DOMContentLoaded', function() {
    document.getElementById('saveChangesBtn').addEventListener('click', function(event) {
        ...
        xhr.open('POST', 'change_password_patient.php', true);
