...
<head>
    <title>Doctor Patient Records Table Archived</title>
    <!-- Bootstrap -->
            ...
            <li class="profile">
                <a>
                    ...
                    <span class="link_name">
                        <?php echo $_SESSION['first_name'], ' ', $_SESSION['last_name'] ?>
                        <br>
                        <span class="admin_text">Doctor Account</span>
                    </span>
                </a>
            </li>
                            ...
                            <tbody>
                                ...
                                foreach ($inactivePatients as $patient) {
                                    ...
                                    <tr class="cursor-pointer hover:bg-[#eeeeee]">
                                        ...
                                        <form action="DoctorViewPatientArchived.php" method="get">
                                            <td>
                                                <input type="hidden" name="caseNo"
                                                    value="<?php echo $patient['case_no']; ?>">
                                                <button name ="DoctorviewButtonArchived" type="submit"
...
document.getElementById('log_out').addEventListener('click', function() {
    ...
    document.getElementById('confirmLogout').addEventListener('click', function() {
        ...
        function performSearch(searchTerm) {
            const url = `DoctorPatientRecordsTableArchived.php?search=${encodeURIComponent(searchTerm)}`;
        ...
        searchInput.addEventListener('input', () => {
            ...
            searchTimeout = setTimeout(() => {
                if (searchTerm.length >= 3) {
                    ...
                    window.location.href = 'DoctorPatientRecordsTableArchived.php';
                }
