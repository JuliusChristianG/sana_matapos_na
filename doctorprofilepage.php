            ...
            <ul class="nav-list">
                ...
                <li class="">
                    <a href="DoctorAddPatient.php">
                        ...
                        <span class="link_name">Add Patient</span>
                    </a>
                    <span class="tooltip">Add Patient</span>
                </li>
           ...
           <form id="editProfile" action="editProfile.php" method="post">
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input name="username" type="text" class="form-control mb-1" style="width: 550px;" pattern="[^\s]+" value="<?php echo $_SESSION['username']; ?>">
                                            </div>
                                            <br>
                                            <div class="form-group">
...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.15.4/css/all.css" integrity="sha384-DyZ88mC6Up2uqS4h/KRgHuoeGwBcD4Ng9SiP4dIRy0EXTlnuz47vAwmeGwVChigm" crossorigin="anonymous" />
    ...
    <form action="change_password_doctor.php" method="post" onsubmit="return validatePassword()">
        <div class="card-body pb-2">
          <div class="form-group">
    <label class="form-label">Current password</label>
    <div class="input-group">
        <input type="password" class="form-control" name="current_password" id="current_password" style="width: 550px;"  pattern="[^\s]+" placeholder="Current Password" required>
...
<div class="form-group">
    ...
    <div class="input-group">
        <input type="password" class="form-control" name="new_password" id="new_password" style="width: 550px;"  pattern="[^\s]+" placeholder="New Password" required>
...
<div class="form-group">
    ...
    <div class="input-group">
        <input type="password" class="form-control" name="confirm_password" id="confirm_password" style="width: 550px;" pattern="[^\s]+" placeholder="Retype New Password" required>
...
document.addEventListener('DOMContentLoaded', function() {
    document.getElementById('saveChangesBtn').addEventListener('click', function(event) {
        ...
        xhr.open('POST', 'change_password_doctor.php', true);
