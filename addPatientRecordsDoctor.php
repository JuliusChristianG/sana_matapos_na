...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Prepare the SQL query to insert the patient record
    $addPatientQuery = "INSERT INTO patient_records (fname, lname, mname, address, age, birthday, birthplace, civilStatus, gender, mobileNumber, religion, occupation, dateAdded, userID, active) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,now(),?, 1)";
    ...
    $logStmt->bindParam(1, $doctorUserID); // Assuming you want to log the user who added the record
    ...
    header("Location: DoctorPatientRecordsTable.php");
    exit;
}
