...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        ...
        $stmtLog->bind_param("isssss", $doctorUserID, $loggedInUsername, $loggedInRole, $date, $time, $action);
        $stmtLog->execute();
        ...
        header('Location:DoctorViewPatient.php?caseNo=' . $caseNo); // Redirect to another page after successful insert
        exit;
    } else {
        die("Error: " . $db->error);
    }
