        ...
        <div class="container">
            <div class="card shadow rounded">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="addPatientRecords.php?user_id=<?php echo $userId; ?>" class="row g-3"
                        id="patientForm">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="age" required class="form-control rounded-pill"
                                placeholder="Age" oninput="checkInput(this)">
                        </div>
