...
if ($_SESSION['role'] !== 'Staff') {
    // If the user is not an Staff, you can redirect them to an error page or another appropriate page.
...
<body class="">
    ...
    <section class="home-section">
       ...
       placeholder="Search by Last Name" style="width: 250px; height: 30px;">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <tbody id="patientTableBody">
                        ...
                        $filteredPatients = array_filter($patients, function ($patient) {
                            if (isset($_GET['search'])) {
                                $search = strtolower($_GET['search']);
                                $lastName = strtolower($patient['last_name']);
                                return strpos($lastName, $search) !== false;
                            }
                            return true;
                        });
                        
                        // Sort the $filteredPatients array by 'dateAdded' in descending order (most recent first)
                        ...
                        $totalTables = ceil(count($filteredPatients) / $patientsPerPage);
                        
                        $startIndex = ($currentTable - 1) * $patientsPerPage;
                        $endIndex = min($startIndex + $patientsPerPage, count($filteredPatients));
