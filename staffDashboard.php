        ...
        <section id="content">
            ...
            <main>
                ...
                <div style="display: flex;">
                    ...
                    <div style="width: 30%; display: flex; flex-direction: column; align-items: center; text-align: center; margin-left: 13%;">
                        <div style="font-weight: bold; font-size: 18px; margin-bottom: 10px;">
                            Patients' Age Groups
                        </div>
                        <canvas id="myChart1" width="100" height="100"></canvas> <!-- Adjust the width and height as needed -->
                    </div>
                ...
                <div style="display: flex; flex-wrap: wrap; justify-content: space-between;">
                    ...
                    <div style="width: 50%;"> <!-- Adjust the width as needed -->
                        <div style="display: flex; justify-content: flex-start; align-items: center; text-align: center; height: 100px;">
