...
try {
    ...
    if (isset($_GET['caseNo'])) {
        ...
        if (isset($_GET['viewButtonDoctor'])) {
            ...
            header("Location: DoctorViewPatient.php?caseNo=$caseNo");
            exit();
        }
    } else {
                                ...
                                <div>
                                    ...
                                    <div class="pb-1 flex justify-between">
                                        ...
                                        <div> <!-- Wrap the Previous and Next buttons in a container -->
                                            <?php if ($prev != 0): ?>
                                                <a href="DoctorViewPatient.php?caseNo=<?= $prev ?>"><button
                                            ...
                                            <?php if ($next != 0): ?>
                                                <a href="DoctorViewPatient.php?caseNo=<?= $next ?>"><button
