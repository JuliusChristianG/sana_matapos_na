...
<head>
    <title>Admin Patient Records Table</title>
...
<body class="">
    <div class="sidebar bg-[#e4e9f7]">
        <div class="logo_details">
            ...
            <div class="logo_name">
                <img src="assets/images/mylabLogo.png" height="30px" width="30px" class="ml-3" alt="MyLab Logo">
            </div>
            ...
            <div class="card shadow rounded">
                ...
                <div class="card-header bg-white">
                    ...
                    <div class="d-flex justify-content-end mb-3">
                        ...
                        <div class="ml-2">
                            <a href="adminPatientRecordsTableArchived.php" class="btn btn-primary btn-lg rounded-pill px-4 py-2 bg-[#0126CC] text-white hover:bg-blue-600 hover:text-white">Archived
                                Records</a>
                        </div>
                        <div class="ml-2">
                            ...
                            <tbody>
                                <?php foreach ($activePatients as $patient) { ?>
                                    <tr class="cursor-pointer hover:bg-[#eeeeee]">
                                        ...
                                        <form action="adminViewPatient.php" method="get">
                                            <td>
                                                <input type="hidden" name="caseNo" value="<?php echo $patient['case_no']; ?>">
                                                <button name ="viewButton" type="submit" class="ml-1 rounded-lg bg-[#0126CC] px-4 text-white hover:bg-[#6257b4] text-white p-2 text-sm">View</button>
                                            </td>
                                        </form>
                    </div>
                    </td>
