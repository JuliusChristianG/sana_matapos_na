...
try {
    ...
    if (isset($_GET['caseNo'])) {
        ...
        if (isset($_GET['viewButton'])) {
            ...
            $action = "Viewed patient record with Case No. MLC - $caseNo";
            ...
            header("Location: adminViewPatient.php?caseNo=$caseNo");
                            ...
                            <div class="card-body">
                                <div>
                                    ...
                                    <div class="pb-1 flex justify-between">
                                        ...
                                        <div> <!-- Wrap the Previous and Next buttons in a container -->
                                            <?php if ($prev != 0): ?>
                                                <a href="adminViewPatient.php?caseNo=<?= $prev ?>"><button
                                            ...
                                            <?php if ($next != 0): ?>
                                                <a href="adminViewPatient.php?caseNo=<?= $next ?>"><button
                                ...
                                <div class="grid grid-cols-3 my-4">
                                    ...
                                    <div class="col-span-2 rounded-lg bg-gray-200 p-4 ml-4">
                                        ...
                                        <hr class="my-2">
                                        <form action="uploadImageFile.php" method="POST" enctype="multipart/form-data"
