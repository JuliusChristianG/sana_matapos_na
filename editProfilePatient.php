...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($mysqli, $updateQuery)) {
        ...
        $caseNo = $_SESSION['case_no']; // Assuming you have a case_no in your session
        header("Location: patient_profilepage.php?caseNo=" . $_GET['caseNoRedirect']);
